 ...
 <div className="split-img-wrapper w-[100vw] relative flex flex-col justify-center place-content-center place-items-center">
  <div className="split-img-full md:h-[70vh] w-[100vw] md:flex justify-center place-content-center place-items-center bg-[#fffbec] outline z-[400]">
    <motion.div 
      ...
      className="split-img-container-left md:h-[70dvh] h-[50dvh] md:w-[33.3vw] w-[100vw] flex justify-center place-content-center place-items-center bg-[#fffbec] relative outline"
    >
      <motion.div 
        initial="hidden"
        whileInView="visible"
    ...
    <motion.div 
      ...
      transition={{ duration: 1.6 }}
      variants={combinedVariantsYbottom} 
      className="split-img-container-middle md:h-[70dvh] h-[50dvh] md:w-[33.3vw] w-[100vw] flex justify-center place-content-center place-items-center bg-[#fffbec] relative outline">
      <motion.div 
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
    ...
    <motion.div
      ...
      className="split-img-container-right md:h-[70dvh] h-[50dvh] md:w-[33.3vw] w-[100vw] flex justify-center place-content-center place-items-center outline relative bg-[#fffbec]">
      <motion.div 
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
    ...
    <div className="split-img-text-bottom
w-[100vw]
flex
flex-col
bg-[#fffbec]
